#!/bin/bash
# Full build and notarization script for Laptop Battery Test (macOS)
...
echo -e "${BLUE}=== Laptop Battery Test Build & Release Script ===${NC}"
...
if command -v create-dmg &> /dev/null; then
    ...
    DMG_NAME="${APP_NAME}-${APP_VERSION:-1.0.0}.dmg"
